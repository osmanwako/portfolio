...
for (let i = 0; i < data.length; i += 1) {
  elements[i].addEventListener('click', () => {
    ...
    li33.className = 'title-and-year';
    li33.textContent = `${data[i].technologies[0].teck3}`;
    li44.className = 'title-and-year';
    li44.textContent = `${data[i].technologies[0].teck4}`;
    li55.className = 'title-and-year';
    li55.textContent = `${data[i].technologies[0].teck5}`;
    ...
    ul2.append(li11, li22, li33, li44, li55);
    ul1.append(li1, li2, li3);
